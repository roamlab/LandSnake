// Generated by gencpp from file snake_demo/torques.msg
// DO NOT EDIT!


#ifndef SNAKE_DEMO_MESSAGE_TORQUES_H
#define SNAKE_DEMO_MESSAGE_TORQUES_H
...
struct torques_
{
  ...
  typedef boost::shared_ptr< ::snake_demo::torques_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::snake_demo::torques_<ContainerAllocator> const> ConstPtr;

}; // struct torques_

typedef ::snake_demo::torques_<std::allocator<void> > torques;

typedef boost::shared_ptr< ::snake_demo::torques > torquesPtr;
typedef boost::shared_ptr< ::snake_demo::torques const> torquesConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::snake_demo::torques_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::snake_demo::torques_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::snake_demo::torques_<ContainerAllocator1> & lhs, const ::snake_demo::torques_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::snake_demo::torques_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::snake_demo::torques_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::snake_demo::torques_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::snake_demo::torques_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::snake_demo::torques_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::snake_demo::torques_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::snake_demo::torques_<ContainerAllocator> >
{
  ...
  static const char* value(const ::snake_demo::torques_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x0391199eca786947ULL;
  static const uint64_t static_value2 = 0xffc0b714f855b349ULL;
};

template<class ContainerAllocator>
struct DataType< ::snake_demo::torques_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::snake_demo::torques_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::snake_demo::torques_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::snake_demo::torques_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::snake_demo::torques_<ContainerAllocator>& v)
  {
    s << indent << "timestamp: ";
...
#endif // SNAKE_DEMO_MESSAGE_TORQUES_H
