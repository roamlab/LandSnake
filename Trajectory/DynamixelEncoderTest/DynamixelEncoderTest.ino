...
void loop() {
  ...
  DEBUG_SERIAL.print(dxl.getPresentPosition(DXL_ID, UNIT_DEGREE) - default_ang);
  DEBUG_SERIAL.print('\n')
  encoderAngle = 360*(analogRead(Encoder_pin)-ori_ang)/1024
  DEBUG_SERIAL.print('Encoder angle is :')
  DEBUG_SERIAL.print(encoderAngle)
  DEBUG_SERIAL.print('\n')
