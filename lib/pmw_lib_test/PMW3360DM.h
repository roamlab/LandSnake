// PMW3360 registers and firmware
#ifndef __PMW3360DM__
#define __PMW3360DM__
...
// Loaded every time on bootup 
const unsigned short PMW3360_firmware_length = 4094;
const unsigned char PMW3360_firmware_data[] PROGMEM = {
