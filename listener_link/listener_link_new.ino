...
unsigned int PIDPERIOD_US = 600; // PERIOD OF PID TIMING
...
double kp = 1.15, ki = 0.0001 , kd = 1.6; // CONTROLLER GAINS
...
void ExecuteCommand() {
  ...
  if(abs(error)>=0.4){ // CONSIDER CHANGING TO ">= RES" ?
...
void setup() {
  ...
  PIDTimer.begin(ExecuteCommand, PIDPERIOD_US);
}
